...
export const SCHEMA = {
  ...
  appraisalCycles: {
    ...
    labels: { Title: 'ชื่อรอบ', FormSet: 'ชุดแบบประเมิน', Round: 'ครั้งที่', RoundDate: 'วันที่ประเมิน', Status: 'สถานะรอบ', Stage: 'ขั้นตอนที่เปิด',
  ...
  appraisals: {
    ...
    labels: { CycleName: 'รอบ', FormSet: 'ชุดแบบประเมิน', EmployeeName: 'ผู้ถูกประเมิน', Department: 'ฝ่าย',
