  ...
  appraisalCycles: {
    ...
    fields: [
      ...
      { key: 'FormSet', label: 'ชุดแบบประเมินที่ใช้', type: 'choice', required: true,
        options: ['ประเมินบุคลากรผ่านงาน รอบที่ 1', 'ประเมินบุคลากรผ่านงาน รอบที่ 2',
                  'ประเมินบุคลากรผ่านงาน รอบที่ 3', 'ประเมิน KPI ประจำปี'],
      ...
      { key: 'Members', label: 'รายชื่อผู้ถูกประเมิน', type: 'textarea', full: true,
        help: 'ใช้เมื่อเลือก "เฉพาะรายชื่อที่ระบุ" · บรรทัดละ 1 คน ใส่อีเมลหรือชื่อ-นามสกุลตามทะเบียนบุคลากร' },
