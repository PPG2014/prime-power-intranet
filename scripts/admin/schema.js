...
export const SCHEMA = {
  ...
  appraisalCycles: {
    ...
    columns: ['Title', 'FormSet', 'Round', 'Status', 'Stage', 'Scope', 'StartDate', 'EndDate'],
    labels: { Title: 'ชื่อรอบ', FormSet: 'ชุดแบบประเมิน', Round: 'ครั้งที่', Status: 'สถานะรอบ', Stage: 'ขั้นตอนที่เปิด',
    ...
    fields: [
      ...
      { key: 'Round', label: 'ประเมินครั้งที่', type: 'choice',
        ...
        help: 'ใช้กับแบบผ่านงาน · วันที่ของแต่ละครั้งกรอกได้ในใบประเมินรายคน' },
