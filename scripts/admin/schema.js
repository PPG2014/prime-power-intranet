...
export const SCHEMA = {
  ...
  appraisalCycles: {
    ...
    columns: ['Title', 'FormSet', 'Status', 'Stage', 'Scope', 'StartDate', 'EndDate'],
    labels: { Title: 'ชื่อรอบ', FormSet: 'ชุดแบบประเมิน', Status: 'สถานะรอบ', Stage: 'ขั้นตอนที่เปิด',
    ...
    fields: [
      ...
      { key: 'FormSet', label: 'ชุดแบบประเมินที่ใช้', type: 'choice', required: true,
        options: ['ประเมินบุคลากรผ่านงาน รอบที่ 1 (30 วัน)', 'ประเมินบุคลากรผ่านงาน รอบที่ 2 (60 วัน)',
                  'ประเมินบุคลากรผ่านงาน รอบที่ 3 (90 วัน)', 'ประเมินบุคลากรผ่านงาน รอบที่ 4 (120 วัน)',
                  'ประเมิน KPI ประจำปี'],
        help: 'ต้องตรงกับชุดที่ตั้งไว้ในหัวข้อประเมิน · เพิ่มชุดใหม่ได้ที่ตัวเลือกของคอลัมน์นี้ใน SharePoint' },
