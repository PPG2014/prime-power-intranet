...
**วิธีทำ**
1. สร้าง List ใหม่ชื่อ `DocCounter` มีคอลัมน์ FormCode, Year, LastNo
2. ในโฟลว์ตอนมีคำขอใหม่ (Status ว่างหรือรอออกเลข) ให้
   - Get item จาก DocCounter ที่ตรง FormCode + Year
   - เพิ่ม LastNo ทีละ 1 ด้วย **Update item** (SharePoint จัดคิวให้ทีละคน ไม่ชนกัน)
   - เอาเลขใหม่มาประกอบเป็น Title ของคำขอ
